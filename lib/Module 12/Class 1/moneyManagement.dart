...
class _MoneymanagementState extends State<Moneymanagement> with SingleTickerProviderStateMixin{
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  style: ButtonStyle(
                    backgroundColor: WidgetStatePropertyAll(isEarning? Colors.green : Colors.red)
                  ),
                  onPressed: (){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Money Management',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
        bottom: TabBar(
            controller: _tabController,
            tabs: [
          Tab(text: "Earning",icon: Icon(Icons.arrow_upward_outlined)),
          Tab(text: "Expense",icon: Icon(Icons.arrow_downward_outlined)),
        ]),
      ),
      body: Column(
        children: [
